...
const reserveToDrop = "0xb37B60166AC1677a50D0ef158541c441bFf3D09A";
...
async function main() {
  ...
  const poolConfiguratorContract = new ethers.Contract(poolConfiguratorAddress, setReserveFreezeABI, signer);
