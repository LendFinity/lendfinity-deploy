  ...
  const initReserveInput = [
    {
      ...
      underlyingAsset: '0xb7FBeB1d175C05b30FB45c57cA4B272767C1C65C',
      treasury: '0x1Fb0D426927Dab092Def63b73E1397b3F29E7b33',
      incentivesController: '0x5d0352475e1884D72169d0ccf91272321787BE61',
      underlyingAssetName: 'EFG',
      aTokenName: 'Aave Bitfinity EFG',
      aTokenSymbol: 'aBftEFG',
      variableDebtTokenName: 'Aave Bitfinity Variable Debt EFG',
      variableDebtTokenSymbol: 'variableDebtBftEFG',
      stableDebtTokenName: 'Aave Bitfinity Stable Debt EFG',
      stableDebtTokenSymbol: 'stableDebtBftEFG',
      params: '0x10'
    }
  ];
