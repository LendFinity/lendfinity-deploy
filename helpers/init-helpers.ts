...
export const initReservesByHelper = async (
  ...
  for (let i = 0; i < reserveSymbols.length; i++) {
    ...
    initInputParams.push({
      ...
      aTokenName: `Lendfinity ${aTokenNamePrefix} ${reserveSymbols[i]}`,
      aTokenSymbol: `l${symbolPrefix}${reserveSymbols[i]}`,
      variableDebtTokenName: `Lendfinity ${variableDebtTokenNamePrefix} Variable Debt ${reserveSymbols[i]}`,
      variableDebtTokenSymbol: `variableDebt${symbolPrefix}${reserveSymbols[i]}`,
      stableDebtTokenName: `Lendfinity ${stableDebtTokenNamePrefix} Stable Debt ${reserveSymbols[i]}`,
