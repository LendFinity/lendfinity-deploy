...
export const ATOKEN_IMPL_ID = `LToken-${MARKET_NAME}`;
export const DELEGATION_AWARE_ATOKEN_IMPL_ID = `DelegationAwareLToken-${MARKET_NAME}`;
...
export const ORACLE_ID = `LendfinityOracle-${MARKET_NAME}`;
...
export const AAVE_COLLECTOR_PROXY_ID = `LendfinityCollector-${PROXY_ID}-${MARKET_NAME}`;
export const AAVE_COLLECTOR_IMPL_ID = `LendfinityCollector-${IMPL_ID}-${MARKET_NAME}`;
...
export const ATOKEN_PREFIX = `-LToken-${MARKET_NAME}`;
...
export const STAKE_AAVE_PROXY = `StakeLendfinity-${PROXY_ID}`;
export const STAKE_AAVE_IMPL_V1 = `StakeLendfinity-REV-1-${IMPL_ID}`;
export const STAKE_AAVE_IMPL_V2 = `StakeLendfinity-REV-2-${IMPL_ID}`;
export const STAKE_AAVE_IMPL_V3 = `StakeLendfinity-REV-3-${IMPL_ID}`;
